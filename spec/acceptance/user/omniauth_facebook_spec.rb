...
feature 'Sign in, sign up OAuth Facebook', %q{
  In order to be able to sign in, sign up with accounts from Facebook
  As non-authenticated user
  I want to sign in, sign up with these accounts
} do

  given(:provider) { OmniAuth.config.add_mock(:facebook, {uid: '123456'}) }
  given(:provider_with_mail) { OmniAuth.config.add_mock(:facebook, {uid: '123456', info: {email: Faker::Internet.email}}) }
